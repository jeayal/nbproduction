...
export default function ContactUs() {
  ...
  return (
    <main>
      <nav className='flex flex-row items-center justify-between bg-blue-50 p-8 dark:bg-blue-900'>
        <div className='relative flex flex-row items-center space-x-2'>
          <div className='absolute z-10 h-6 w-4 bg-blue-500'></div>
          <div className='absolute left-1 top-0 h-6 w-4 bg-green-500'></div>
        ...
        <div className='flex flex-row items-center space-x-8'>
          <a
            href='#'
            className='hidden text-base font-light text-gray-600 dark:text-gray-50 lg:block'
          >
            Home
          </a>
          <a
      ...
      <header className='grid grid-cols-1 gap-4 bg-blue-50 p-8 pt-10 dark:bg-blue-900 md:h-96 md:grid-cols-2 lg:px-40'>
      ...
      <section className=''>
        ...
        <div className='mx-2 my-20 grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-2 md:mx-auto md:grid-cols-3'>
          <div className='card flex flex-row items-center space-x-4 rounded-md p-8 shadow transition duration-200 hover:cursor-pointer hover:shadow-lg'>
            ...
            <p className='font-light text-gray-500'>+91 9293929392</p>
          </div>
