    ...
    <div className='bg-neutral-100 dark:bg-neutral-950'>
      <div className='layout relative flex flex-col justify-between pt-10 md:flex-row md:py-32'>
        <div id='gauche' className='relative flex flex-col md:mr-0'>
          <div className='relative m-auto flex aspect-square items-center justify-center overflow-hidden rounded-xl bg-neutral-950 object-contain p-4 align-middle text-white drop-shadow-lg md:p-4 dark:bg-neutral-200 dark:text-black'>
            <svg
              version='1.1'
	...
	c17.9-7.6,36.2-14.4,54.8-20.1c9-1.9,18.1-4,27-6.2c5.7-1.2,11.5-1.9,17.3-2.1C986.5,1.5,987.2,0.9,987.6,0L987.6,0z'
        ...
        >
          <form
            ...
            className='mb-10 flex w-full flex-col md:mb-0'
          >
            <label
              htmlFor='subscribe'
            ...
            <div className='flex flex-row gap-4'>
              ...
              <div>
                {isSubmitSuccessful && isSuccess && (
                  <div className=' w-full rounded-lg border-2 border-solid border-green-500 p-2 text-center '>
                    {message && 'Envoyé'}
                  </div>
                )}
                {isSubmitSuccessful && !isSuccess && (
