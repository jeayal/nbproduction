...
export default function CardTournage({ url }: CardProps) {
  return (
      ...
      <div className='group-hover:gradText flex flex-row items-center gap-3 transition-all group-hover:text-blue-500 '>
        ...
        >
          <g>
            ...
            <path d='m328.009 207.024c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5h-47.593c-4.142 0-7.5 3.358-7.5 7.5v112.952c0 4.142 3.358 7.5 7.5 7.5h47.593c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5h-40.093v-41.476h36.584c4.142 0 7.5-3.358 7.5-7.5s-3.358-7.5-7.5-7.5h-36.584v-41.476z' />
            <path d='m463.15 301.726c2.662-3.174 2.247-7.904-.927-10.566-3.173-2.662-7.904-2.247-10.566.927-1.202 1.433-2.503 2.776-3.868 3.991-7.017 6.25-15.863 9.418-26.293 9.418-27.292.001-49.496-22.204-49.496-49.496s22.204-49.497 49.497-49.497c9.92 0 19.487 2.921 27.668 8.449 3.432 2.319 8.095 1.417 10.413-2.016 2.319-3.432 1.417-8.094-2.016-10.413-10.67-7.209-23.142-11.02-36.066-11.02-35.563 0-64.496 28.934-64.496 64.497s28.933 64.497 64.497 64.497c14.02 0 26.562-4.57 36.27-13.217 1.903-1.697 3.715-3.565 5.383-5.554z' />
            ...
            <path d='m132.097 256c0-17.92-14.58-32.5-32.5-32.5s-32.5 14.58-32.5 32.5 14.58 32.5 32.5 32.5 32.5-14.58 32.5-32.5zm-50 0c0-9.649 7.851-17.5 17.5-17.5s17.5 7.851 17.5 17.5-7.851 17.5-17.5 17.5-17.5-7.851-17.5-17.5z' />
          </g>
        </svg>
        <h1 className='text-4xl'>Tournage</h1>
      </div>

      <p>
        Réalisez une expérience visuelle extraordinaire avec mes services de
        tournage. Doté d'une vision artistique distinctive, je capture et
        magnifie chaque instant, partout dans le monde. Transformez vos idées en
        une réalité visuelle mémorable.
      </p>
      <Button
        url={url}
        primary
        aria='Tourner ma vidéo'
        txt='Tourner ma vidéo'
      />
    </div>
  );
}
