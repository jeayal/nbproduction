...
export default function Socials({ lk, tw, vi, fb, ig, size, faded }: any) {
  return (
    <div
      id='svg'
    ...
    >
      <a href={social.fb} aria-label='Mon profil Facebook'>
        <svg
      ...
      <a href={social.tw} aria-label='Mon profil Tweeter'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width={size}
          height={size}
      ...
      <a href={social.ig} aria-label='Mon profil Instagram'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width={size}
          height={size}
      ...
      <a href={social.lk} aria-label='Mon profil Linkedin'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width={size}
          height={size}
      ...
      <a href={social.vi} aria-label='Mon profil Viméo'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width={size}
          height={size}
