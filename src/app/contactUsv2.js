...
export default function ContactUs() {
  ...
  //   Setting button text
  const [buttonText, setButtonText] = useState('Envoyer V2');
  ...
  async function handleSubmit(event) {
    ...
    formData.append('access_key', 'd2358867-ff67-4856-bc87-c0c848359f2e');
     ...
     md:h-96 md:grid-cols-2 lg:px-40'
      >
        <div className='mx-auto mb-10 px-20 md:mt-20'>
          ...
          <div className='my-6 flex flex-row items-center space-x-8'>
        ...
        >
          ...
          />
          {errors?.fullname && (
            <p className='text-red-500'>Votre nom ne peut être vide.</p>
          )}
          ...
          />
          {errors?.email && (
            <p className='text-red-500'>Votre e-mail ne peut être vide.</p>
          )}
          ...
          />
          {errors?.subject && (
            <p className='text-red-500'>Le sujet ne peut être vide.</p>
          )}
          <label
            htmlFor='message'
            className='mt-4 font-light text-gray-500 dark:text-gray-50'
          ...
          ></textarea>
          {errors?.message && (
            <p className='text-red-500'>La demande ne peut être vide.</p>
          )}
          ...
          <div className='text-left'>
            ...
            {showFailureMessage && (
              <p className='text-red-500'>
                Oups, une erreur est survenue ! Veuillez réessayer ou envoyer un
                mail directement à contact@blanc-nicolas.com
              </p>
            )}
          </div>
        </form>
      ...
      <section className=''>
        <h1
          className={`gradient-text my-10 text-center text-4xl font-bold text-gray-700 md:mt-60 ${
            errors ? 'md:mt-80' : 'md:mt-60'
          }`}
        >
          Retrouvez-moi ici
        </h1>
        <div className='mx-2 my-20 grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-2 md:mx-auto md:grid-cols-3'>
          <div className='card flex flex-row items-center space-x-4 rounded-md p-8 shadow transition duration-200 hover:cursor-pointer hover:shadow-lg'>
            <svg
              width='24'
              height='24'
              viewBox='0 0 24 24'
            ...
            <p className='font-light text-gray-500'>06.07.08.09.10</p>
          </div>
          ...
          <div className='card flex cursor-pointer flex-row items-center space-x-4 rounded-md p-8 shadow transition duration-200 hover:shadow-lg'>
            ...
            <p className='font-light text-gray-500'>@nicolasblanc</p>
          </div>
        </div>
      </section>
    </main>
